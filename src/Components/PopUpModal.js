...
import { handleAddItem,handleUpdateItem,
    handleDeleteItem,addItem,updateItem,deleteItem,onNameChange,onCountryChange,onFavMobBrandChange,onPhoneNumberChange } from '../redux/actionCreators/index';
...
class PopupModal extends React.Component{
    ...
    handleOnPressEvent = (eventType) => {
        ...
        const { 
            ...
            data,id,handleDeleteItem } = this.props;
